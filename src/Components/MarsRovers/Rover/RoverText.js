...
export default function RoverText({ roverName }) {
  ...
  if (roverName === 'Curiosity')
    roverText = `
        ...
        touchdown target after a 560 million km (350 million mi) journey.
        The rover&apos;s goals include an investigation of the Martian climate and geology;
        assessment of whether the selected field site inside Gale has ever offered environmental
        conditions favorable for microbial life, including investigation of the role of water;
        and planetary habitability studies in preparation for human exploration. In December 2012,
        Curiosity&apos;s two-year mission was extended indefinitely, and on August 5, 2017,
        NASA celebrated the fifth anniversary of the Curiosity rover landing.
        The rover is still operational, and as of May 25, 2020, Curiosity has been on Mars for 2774
        sols (2849 total days) since landing on August 6, 2012.`;
  ...
  if (roverName === 'Spirit')
    roverText = `
        ...
        active from 2004 to 2010. It was one of two rovers of NASA&apos;s
        Mars Exploration Rover
        Mission. It landed successfully within the impact crater Gusev on Mars at 04:35
        Ground UTC on
        ...
        energy from its solar panels, Spirit went on to function effectively over twenty
        times longer
        ...
        (the 90-sol prime mission) were published in a special issue of the journal Science.
        On May 1,
        ...
        obstructed by its location in soft sand,[9] though it continued to perform scientific
        research
        from its current location.[10] The rover continued in a stationary science platform
        role until
